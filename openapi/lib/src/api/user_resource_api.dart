...
class UserResourceApi {
  ...
  Future<Response<void>> deleteUser({ 
    ...
    final _path = r'/api/admin/users/{login}'.replaceAll('{' r'login' '}', login.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<AdminUserDTO>>> getAllUsers({ 
    ...
    try {
      const _responseType = FullType(BuiltList, [FullType(AdminUserDTO)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<AdminUserDTO>> getUser({ 
    ...
    try {
      const _responseType = FullType(AdminUserDTO);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as AdminUserDTO;
