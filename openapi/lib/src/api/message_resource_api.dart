...
class MessageResourceApi {
  ...
  const MessageResourceApi(this._dio, this._serializers);
  ...
  Future<Response<MessageDTO>> createMessage({ 
    ...
    try {
      const _responseType = FullType(MessageDTO);
  ...
  Future<Response<void>> deleteMessage({ 
    ...
    final _path = r'/api/messages/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<MessageDTO>>> getAllMessages({ 
    ...
    try {
      const _responseType = FullType(BuiltList, [FullType(MessageDTO)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  /// Returns a [Future] containing a [Response] with a [MessageDTO] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<MessageDTO>> partialUpdateMessage({ 
    required int id,
    required MessageDTO messageDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
